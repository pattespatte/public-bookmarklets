// Description: Checks form fieldsets - finds radio/checkbox inputs, verifies fieldset/legend wrapper, reports missing elements
(function() {
  'use strict';
  try {
    ...
    const existingHighlights = document.querySelectorAll('.fsc-highlight, .fsc-missing, .fsc-good');
    ...
    window.highlightGroup = function(index) {
      ...
      document.querySelectorAll('.fsc-highlight, .fsc-missing, .fsc-good').forEach(el => {
        el.classList.remove('fsc-highlight', 'fsc-missing', 'fsc-good');
      });
