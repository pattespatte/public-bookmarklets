...
javascript:(function() {
	"use strict";
// Description: Helper tools for JAWS screen reader testing

	function addJAWSGuide() {
		var modal = document.createElement("div");
		modal.id = "jaws-helper-modal";
		modal.style.cssText = "position:fixed;top:50%;left:50%;transform:translate(-50%, -50%);z-index:10000;background:#fff;color:#111;box-shadow:0 4px 6px rgba(0,0,0,0.1);border-radius:8px;width:90%;max-width:90%;max-height:90%;overflow-y:auto;padding:1em;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;";
