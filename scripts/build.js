...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .test-pages { margin: 20px 0; padding: 15px; background: var(--quick-test-bg); border-left: 4px solid #ffc107; border-radius: 4px; }
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .instructions ol { margin-left: 20px; }
    .instructions li { margin-bottom: 8px; }
    .collection-item { display: flex; align-items: center; justify-content: space-between; gap: 15px; padding: 15px 20px; border: 1px solid var(--border-color); border-radius: 8px; margin-bottom: 12px; transition: box-shadow 0.2s, background 0.2s; }
    .collection-item:hover { box-shadow: 0 2px 8px var(--shadow-subtle); background: var(--bg-hover); }
    .collection-info { flex: 1; }
    .collection-info a { text-decoration: none; color: inherit; font-size: 1.1rem; font-weight: 500; }
    .collection-info a:hover { color: var(--text-link); }
    .collection-info p { margin-top: 5px; color: var(--text-secondary); font-size: 0.9rem; }
