...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="Accessibility & utility bookmarklets for web testing and WCAG evaluation">
    ...
    <main class="card">
      <div class="quick-links">
        <div class="quick-link-box collections">
          <a href="${isPrivate ? '../collections/index.html' : 'collections/index.html'}">
            <h2>📦 Collections</h2>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="Download bookmarklet collections for bulk import - Accessibility testing tools organized by category">
